...
def main() -> None:
    ...
    parser.add_argument("--phase2-steps", type=int, default=100)
    parser.add_argument("--phase3-steps", type=int, default=100)
    parser.add_argument("--max-ues-phase1", type=int, default=500)
    parser.add_argument("--max-ues-phase2", type=int, default=5000)
